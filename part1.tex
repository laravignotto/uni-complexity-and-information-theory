...
Sia $f(x)=\textcolor{Cerulean}{-x\log_2x}$ (cfr.~definizione di entropia). Vogliamo controllare se è concava o convessa, calcoliamo quindi la sua derivata seconda:
$$
    f''(x) = -\frac{1}{x}
$$
...
$$
\textcolor{ForestGreen}{\sum_{i=1}^n\lambda_if(x_i)} \leq f\left(\sum_{i=1}^n\lambda_ix_i\right)
$$
...
$$
    \lambda_i=\frac{1}{k} \qquad\qquad |P|=|X|=k \qquad\qquad P=\{p1,\dots,p_k\}
$$
scriviamo la disuguaglianza di Jensen come
\begin{eqnarray*}
    \textcolor{ForestGreen}{\sum_{i=1}^k\frac{1}{k}\left(-p_i\log_2p_i\right)} & \leq &\textcolor{Cerulean}{-\left(\sum_{i=1}^k\frac{1}{k}p_i\right)\log_2\left(\sum_{i=1}^k\frac{1}{k}p_i\right)}\\
