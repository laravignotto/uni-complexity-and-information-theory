...
%%%%%%%%%%
\title{\fontfamily{cmss}\fontsize{50}{60}\selectfont \textbf{Appunti di Complessità e Teoria dell'Informazione}}
\author{}
...
angle=0,
opacity=0.2,  %% adjust
contents={\includegraphics[keepaspectratio]{cover1.jpeg}}
}
\BgThispage
